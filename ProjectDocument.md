...
- *Narrative UI* - After the demo, I added [another UI element](https://user-images.githubusercontent.com/15057519/121477897-0288f080-c98e-11eb-9d88-6520f200a6fb.png) that explains the backstory of the game when the player begins to the level.
...
- Might be a bit too complex to figure out in time, but consider buffing the down smash. This could be done by increasing the range of damage, reducing the cast speed, or allowing the player to cast down smash while in the air. *(Might need more testing, but the cast speed was reduced!)*
...
- *Narrative UI* - After seeing all the demos and how other students incorporated the narrative, I wanted to give the backstory of the game in the acutal game, so the [narrative UI](https://user-images.githubusercontent.com/15057519/121513789-dc287c80-c9b0-11eb-92ab-d10e6ac637b6.png) was created to explain the backstory of Urumir.
